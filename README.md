...
상세는 [System Architecture](https://vps-amhs.vercel.app/docs/architecture.html).
...
> **[HTML Documentation](https://vps-amhs.vercel.app/docs/index.html)** — 브라우저에서 바로 열어볼 수 있는 전체 문서

| 문서 | 내용 |
|------|------|
| [System Architecture](https://vps-amhs.vercel.app/docs/architecture.html) | 스레드 분리, 메모리 레이아웃, Multi-Fab Grid |
| [Simulation Engine](https://vps-amhs.vercel.app/docs/simulation.html) | SimulationEngine, FabContext, 시뮬레이션 루프 |
| [Routing (BPR / EWMA)](https://vps-amhs.vercel.app/docs/routing.html) | Dijkstra, BPR 혼잡 모델, EWMA 실측 라우팅 |
| [UI & Menu System](https://vps-amhs.vercel.app/docs/ui-guide.html) | React 메뉴 구조, 실시간 통계, Fab Group |
| [Parameter Preset](https://vps-amhs.vercel.app/docs/preset-system.html) | JSON 프리셋, 맵+Fab+차량 일괄 로드 |
| [Logging & Data Pipeline](https://vps-amhs.vercel.app/docs/logging.html) | OPFS 바이너리 로그, MQTT 전송 |
