...
상세는 [System Architecture](public/docs/architecture.html).
...
> **[HTML Documentation](public/docs/index.html)** — 브라우저에서 바로 열어볼 수 있는 전체 문서

| 문서 | 내용 |
|------|------|
| [System Architecture](public/docs/architecture.html) | 스레드 분리, 메모리 레이아웃, Multi-Fab Grid |
| [Simulation Engine](public/docs/simulation.html) | SimulationEngine, FabContext, 시뮬레이션 루프 |
| [Routing (BPR / EWMA)](public/docs/routing.html) | Dijkstra, BPR 혼잡 모델, EWMA 실측 라우팅 |
| [UI & Menu System](public/docs/ui-guide.html) | React 메뉴 구조, 실시간 통계, Fab Group |
| [Parameter Preset](public/docs/preset-system.html) | JSON 프리셋, 맵+Fab+차량 일괄 로드 |
| [Logging & Data Pipeline](public/docs/logging.html) | OPFS 바이너리 로그, MQTT 전송 |
