...
import FloatingPanel from "../menu/shared/FloatingPanel";
...
const DataPanel: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <FloatingPanel
      ...
      onClose={onClose}
      dragResizeOpts={{
        defaultX: 0, defaultY: 60, defaultW: 750,
        defaultH: window.innerHeight - 160,
        minW: 400, minH: 250,
      }}
      bgClass="bg-gray-900/95"
      headerExtra={<SessionSelector value={sessionId} onChange={setSessionId} dbUrl={dbUrl} />}
      subHeader={tabBar}
    >
